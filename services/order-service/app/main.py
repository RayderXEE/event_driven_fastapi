...
from app.models.order import Order  # noqa: F401 - needed for Base.metadata
import asyncio
import sys
import os
...
def custom_openapi():
    """Enhanced OpenAPI schema with security, contact, and license info."""
...
Event-driven microservice built with FastAPI and Kafka.
...
## API Endpoints
- **Orders Management**: Create, read, list, and cancel orders
